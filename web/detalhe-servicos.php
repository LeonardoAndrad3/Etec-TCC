    ...
    <section class="conteudo-detalhes">
        ...
        <div class="detalhes">
            ...
            <ul class="detalhe-encontrar">
               <?php echo "<iframe class='mapa-google' width='300' height='250' style='border:0;' allowfullscreen='' loading='lazy' src='https://www.google.com/maps/embed/v1/place?key=AIzaSyCAcV6JSwmuPsbOtY7qHrAS6Xf6dORB16k
                &q=".$row['cep']."' ></iframe>"?>
            </ul>
