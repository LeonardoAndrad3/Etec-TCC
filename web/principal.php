...
<html lang="pt-br">
    ...
    <body>
        ...
        <section class="conteudo">
            ...
            print "Successfully created connection to database.<br/></br>";
                    
            $result = pg_query("select nome, email, cpf from Chaveiro;");
            echo("Chaveiros disponíveis: <br></br>");
            while($row = pg_fetch_assoc($result)){
                echo "Nome: " . $row['nome'] . "</br>" . "Email: " . $row['email'] . "</br>" . "CPF: " . $row['cpf']."</br></br></br>";
            }
        ?>
                </div>
            </div>
